...
// Diferentemente que acontece com dados primitivos, as listas, as referencias e os objetos podem ser modificados livremente pelo codigo, e mais, quando atribuimos um valor de referencia em outro, se fizermos alterações em a, as alterações vão se refletir em b e vice versa, pois ao invés de captar somente os valores que está endereçada aquela variavel, nos valores de referencia nos estamos indicando um conjunto de itens iteraveis.
...
// Existe uma forma em que a lista receba os valores de outra, porém continue independente, utilizando a notação [... (NomeDaListaCopiada)]. Assim conseguimos que as duas listas sejam totalmente independentes uma da outra

let ListaTerciaria = [...lista];

lista[4] = 5;
console.log(ListaTerciaria);